...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    {
      slug: "vehicleRentalSystem",
      name: "Vehicle Rental System",
      subtitle: "A comprehensive backend API for managing vehicle rentals, built with modern technologies and best practices.",
      description:
        "A full-featured REST API for managing vehicle rental operations, including user authentication, vehicle management, booking system, and user administration. The system supports multiple user roles (Admin, Customer) with role-based access control.",
      overview: [
        "Authentication & Authorization User registration and login with secure password hashing (bcryptjs) JWT-based authentication for secure API access Role-based access control (RBAC) - Admin and Customer roles Token expiration Vehicle Management Add, update, and retrieve vehicle listings Track vehicle availability and rental status Support for multiple vehicle types Vehicle inventory management Booking System Create and manage vehicle bookings Check vehicle availability for date ranges Booking confirmation and cancellation User Management User profile management Update user information Admin capabilities for user management Role-based user permissions Security Password encryption using bcryptjs JWT token-based authentication Protected routes with authentication middleware Role-based authorization checks",
      ],
      techStack: [
        "Node.js",
        "TypeScript",
      ...
      liveUrl: "https://vehicle-rental-system-delta-five.vercel.app/",
      githubUrl: "https://github.com/abdullahNavin/Vehicle-Rental-System-backend",
      challenges: [
        "Building a robust and scalable backend API for vehicle rental operations.",
        "Implement secure authentication and authorization mechanisms.",
        "Creating a comprehensive booking system with availability management.",
      ],
      futurePlans: [
        "Add a payment gateway integration.",
        "Introduce SMS notifications for booking confirmations and reminders.",
